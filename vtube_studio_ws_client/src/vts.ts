...
export default class Vts {
    ...
    setExpression(data: {
        ...
        this.vts.expressionActivation({ expressionFile: this.#getExpressionName(data.expressionName), active: data.flag }).then((res) => {
    ...
    triggerHotkeyWhenExpressionState(data: {
        ...
        this.vts.expressionState({
            ...
            ///触发热键
            console.log(`vts: triggering hotkey when expression:
